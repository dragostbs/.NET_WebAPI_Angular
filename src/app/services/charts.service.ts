...
export class ChartsService {
  ...
  candlesChart(): any {
    ...
    return (this.candles = {
      ...
      legend: {
        data: ['Chart', 'Volume', 'MA10', 'MA20', 'MA30'],
        inactiveColor: '#777',
      },
      grid: [
        {
